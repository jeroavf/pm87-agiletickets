...
public class EspetaculoTest {
	...
	public void naoCriarSessoesSeDataInicioMaiorQueDataFim_diaria() {
		Espetaculo esp = new Espetaculo() ;
		// Assert.assertEquals(2, sessao.getIngressosDisponiveis().intValue())
		LocalDate dtInicio = new LocalDate() ;
		LocalDate dtFim = dtInicio.plusDays(-1) ;
		LocalTime horario =  LocalTime.parse("10:00") ;
		Periodicidade periodicidade = Periodicidade.DIARIA ;
		List<Sessao> sessoes = esp.criaSessoes( dtInicio, dtFim,  horario , periodicidade) ;
	...
	@Test 
	public void criarSessoesDiariasSeFimMaiorQueInicio() {
		Espetaculo esp = new Espetaculo() ;
		// Assert.assertEquals(2, sessao.getIngressosDisponiveis().intValue())
		LocalDate dtInicio = new LocalDate() ;
		LocalDate dtFim = dtInicio.plusDays(3) ;
		LocalTime horario =  LocalTime.parse("10:00") ;
		Periodicidade periodicidade = Periodicidade.DIARIA ;
		List<Sessao> sessoes = esp.criaSessoes( dtInicio, dtFim,  horario , periodicidade) ;	
